...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyspelling-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13675&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyspelling-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyspelling` can be installed with:

```
conda install pyspelling
```

It is possible to list all of the versions of `pyspelling` available on your platform with:
